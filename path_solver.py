...
def objective(opt_vars,
    ...
    for control_point_quat in control_points_quat:
        ik_result = ik_solver.solve(
                        control_point_quat,
                        start_joint_pos=initial_joint_pos,
                    )
...
class PathSolver:
    ...
    def solve(self,
        ...
        # = other setup
        # ====================================
        _, keypoints_centered = self._center_collision_points_and_keypoints(start_pose, collision_points, keypoints, keypoint_movable_mask)
        aux_args = (og_bounds,
                    start_pose,
                    end_pose,
                    keypoints_centered,
